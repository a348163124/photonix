// Sidebar icons extracted from the Open Design HTML handoff so the React
// shell renders the same glyphs without depending on an icon library.
...
export function PromptCenterIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...baseProps} {...props}>
